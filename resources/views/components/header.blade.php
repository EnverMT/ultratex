...
<header >
    ...
    <div class="max-w-screen-xl mx-auto">
        <div class="flex justify-between items-center">
            <div class="w-40 m-2">
                <a href="{{route('home')}}">
                    <svg xmlns:mydata="http://www.w3.org/2000/svg" mydata:contrastcolor="4d2f41" mydata:template="Contrast"
                    mydata:presentation="2.5" mydata:layouttype="undefined" mydata:specialfontid="undefined" mydata:id1="121"
                    mydata:id2="120" mydata:companyname="UzBum" mydata:companytagline="" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="80 190 390 88">
                    <defs>
